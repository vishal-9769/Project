...
export class AssignmentComponent extends Component {
    constructor(props) {
        super(props);
        ...
        this.state = {
          ...
          this.items = [
            ...
            {
              id: 2,
              AssignmentId: <span>A very long line</span>,
              type: "user",
              dateCreated: (
                <span>
        ...
        this.sortableProperties = new SortableProperties(
            [
              {
                name: "AssignmentId",
                getValue: item => item.AssignmentId.toLowerCase(),
                isAscending: true
              },
              {
                name: "dateCreated",
        ...
        renderRows() {
          const renderRow = item => {
            const cells = this.columns.map(column => {
              ...
              if (column.render) {
                const AssignmentIdText = item.AssignmentId.truncateText
                  ? item.AssignmentId.value
                  : item.AssignmentId;
                const AssignmentId = item.AssignmentId.isLink ? (
                  <EuiLink href="">{item.AssignmentId.value}</EuiLink>
                ) : (
                    AssignmentIdText
                  );
                child = column.render(AssignmentId, item);
